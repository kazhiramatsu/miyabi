...
perl_scalar perl_str_make(struct perl_str *str);
perl_scalar perl_num_make(double val);
perl_scalar perl_int_make(uint64_t val);
perl_array perl_array_make(struct perl_array *array);
perl_hash perl_hash_make(struct perl_hash *hash);
perl_undef perl_undef_new(void);
perl_code perl_code_make(struct perl_code *code);
perl_glob perl_glob_make(struct perl_glob *glob);
_Bool perl_undef_p(perl_scalar val);
double perl_num_value(perl_scalar val);
uint64_t perl_int_value(perl_scalar val);
struct perl_str *perl_str_value(perl_scalar val);
struct perl_array *perl_array_value(perl_array val);
struct perl_hash *perl_hash_value(perl_hash val);
struct perl_code *perl_code_value(perl_code val);
struct perl_glob *perl_glob_value(perl_glob val);
